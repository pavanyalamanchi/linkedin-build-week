    ...
    <Card>
      <Card.Body className="post-card">
          ...
          <Col xs={10} className="post-profile-info">
            <Row className="post-name-and-edit">
              <Col xs={3} className="post-name">
                {prop.user.name + " " + prop.user.surname}
              </Col>
              <Col xs={2} className="post-edit">
                <svg
            ...
            <Row className="post-followers">followers</Row>
            <Row className="post-time">
              {prop.post.createdAt} time • <BiWorld size={14} />
            </Row>
          </Col>
        </Row>
        <div className="post-body">
          <p className={showPost ? "" : "clamp"}>{prop.post.text}</p>
          <div className={showPost ? "d-none" : "post-show-more"}>
            <span onClick={() => SetShowPost(!showPost)}>...see more</span>
          </div>
        </div>
        ...
        <Row className="post-buttons-container">
          ...
          <div className="post-comment" onClick={() => SetShowComment(true)}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="20"
              height="20"
