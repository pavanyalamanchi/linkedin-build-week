...
export default function FeedSidebarProfile(props) {
	return (
  	<Card className="mt-2">
            ...
            <img src={props.user.image} alt="#" className="rounded-circle align-self-center sidebarProfilePhoto"
            />
            </div>
            <Card.Body className="leftSidebarCardBody">
              <h3 style={{fontSize:"16px"}} className="text-center mt-3">{props.user.name} {props.user.surname}</h3>
              <p className="text-center font-weight-light" >{props.user.title}</p>
              <hr></hr>
