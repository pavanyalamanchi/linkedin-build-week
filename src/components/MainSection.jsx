        ...
        <Col sm={8} className="user-info mt-2">
            ...
            <Card.Body className="user-info-body">
              <Row className="justify-content-space-between rows-col-md-6 rows-col-sm-12 rows-col-sx-12 ">
                ...
                <Col>
                  ...
                  <div>
                    <h6 className="member-position">CEO Tesla SpaceX</h6>
                  </div>
                  <div className="d-flex">
                    <p className="text-muted"> 
                      Berlin Metropolitan Area . 
                      <a href=".sample" alt="#" className="profile-contact-info" style={{ textDecoration: "none", fontWeight: "600", color:"#004182" }} >
                        Contact Info
                      </a>
                    </p>
                  </div>
                ...
                <Col className="col d-flex justify-content-center">
                  <ListGroup variant='flush' className='mt-3' >
                    <ListGroup.Item style={{borderBottom:'1px solid white'}}>
                      <SiTesla style={{marginRight:'0.8rem'}} />
                      Tesla
                    </ListGroup.Item>
                    <ListGroup.Item>
                      <SiSpacex style={{marginRight:'0.8rem'}} />
                        SpaceX
                    </ListGroup.Item>
                  </ListGroup>
                </Col>
              ...
              <div>
                <a href='./sample' style={{ textDecoration: "none", fontWeight: "600", fontSize:'medium' }}>
                  500+ Connections
                </a>
              </div>
              <div className='' style={{marginTop:'0.8rem'}}>
                <Button className='btn btn-info text-light rounded-pill mb-2' style={{backgroundColor:'#0a66c2', borderColor:'#0a66c2'}}> 
                  Open To
                </Button>
          ...
          <Card>
            <Card.Body>
                ...
                <Col>
                  <div className="card mb-3">
                    <div className="row no-gutters">
                      ...
                      <div className="col-md-10">
                        <div className="card-body">
                          <h5 className="" style={{fontSize: "16px", lineHeight:"5px"}}>
              ...
              <Button href="#" variant="light" size="lg" style={{width: "100%"}}> 
                See all activity
              </Button>
            </Card.Body>
          </Card>
